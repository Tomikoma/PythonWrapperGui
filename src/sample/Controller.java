...
public class Controller {
    ...
    public void chooseVideo(){
        ...
        fileChooser.getExtensionFilters().addAll(new FileChooser.ExtensionFilter("MP4,AVI","*.mp4", "*.MP4", "*.avi", "*.AVI"));
    ...
    public void startProcessing(){
        ...
        Task task = new Task<Void>() {
            ...
            protected Void call() {
                try {
                    Process p = Runtime.getRuntime().exec("/home/tom/PycharmProjects/opencv/dist/Main " + pathToVideo + " " + rotatingAngle);
                    String s;
                    double progress;
